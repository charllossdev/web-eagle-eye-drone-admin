    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-header">
            ...
            <!-- <a class="navbar-brand" href="index.html"> --> 
                 <!-- dark Logo text -->
                 <!-- <img src="<c:url value='/common/eagleeye-admin/assets/images/eagleeye-black-logo.png'/>" alt="homepage" class="dark-logo" /> -->
                 <!-- Light Logo text -->    
                 <!-- <img src="<c:url value='/common/eagleeye-admin/assets/images/eagleeye-white-logo.png '/>" class="light-logo" alt="homepage" /></span>  -->
            <!-- </a> -->
        </div>
        <!-- ============================================================== -->
        <!-- End Logo -->
