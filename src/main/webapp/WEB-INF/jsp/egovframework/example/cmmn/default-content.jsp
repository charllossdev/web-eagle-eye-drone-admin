 ...
 <div id="DashBoard-Content">       
   <div class="card-group">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="steamline m-t-40">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="img-circle" alt="user" src="<c:url value='/common/images/templet/users/1.jpg'/>"> </div>
                            <div class="sl-right">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="img-circle" alt="user" src="<c:url value='/common/images/templet/users/2.jpg'/>"> </div>
                            <div class="sl-right">
                        ...
                        <div class="sl-item">
                            <div class="sl-left"> <img class="img-circle" alt="user" src="<c:url value='/common/images/templet/users/3.jpg'/>"> </div>
                            <div class="sl-right">
    ...
    <div class="row">
        <div class="col-lg-6">
            <!-- column -->
            <div class="card news-slide" style="background:url(/common/images/templet/background/img5.png) center center / cover;">
                    ...
                    <div class="to-do-widget m-t-20">
                        ...
                        <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                            <li class="list-group-item" data-role="task">
                                ...
                                <ul class="assignedto">
                                    <li><img src="<c:url value='/common/images/templet/users/1.jpg'/>" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                    <li><img src="<c:url value='/common/images/templet/users/2.jpg'/>" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                    <li><img src="<c:url value='/common/images/templet/users/3.jpg'/>" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                    <li><img src="<c:url value='/common/images/templet/users/4.jpg'/>" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                </ul>
                            </li>
                            <li class="list-group-item" data-role="task">
                                <div class="custom-control custom-checkbox">
                    ...
                    <div class="message-box">
                        <div class="message-widget message-scroll">
                            ...
                            <a href="javascript:void(0)">
                                <div class="user-img"> <img src="<c:url value='/common/images/templet/users/1.jpg'/>" alt="user" class="img-circle"> <span class="profile-status online float-right"></span> </div>
                            ...
                            <!-- Message -->
                            <a href="javascript:void(0)">
                                <div class="user-img"> <img src="<c:url value='/common/images/templet/users/2.jpg'/>" alt="user" class="img-circle"> <span class="profile-status busy float-right"></span> </div>
                                <div class="mail-contnet">
                            ...
                            <!-- Message -->
                            <a href="javascript:void(0)">
                                <div class="user-img"> <img src="<c:url value='/common/images/templet/users/4.jpg'/>" alt="user" class="img-circle"> <span class="profile-status offline float-right"></span> </div>
                                <div class="mail-contnet">
                ...
                <div class="card-body">
                    ...
                    <div class="chat-box">
                        ...
                        <ul class="chat-list">
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="<c:url value='/common/images/templet/users/1.jpg'/>" alt="user"></div>
                            ...
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="<c:url value='/common/images/templet/users/2.jpg'/>" alt="user"></div>
                                <div class="chat-content">
                                    <h5>Bianca Doe</h5>
                            ...
                            <!--chat Row -->
                            <li>
                                <div class="chat-img"><img src="<c:url value='/common/images/templet/users/3.jpg'/>" alt="user"></div>
                                <div class="chat-content">
