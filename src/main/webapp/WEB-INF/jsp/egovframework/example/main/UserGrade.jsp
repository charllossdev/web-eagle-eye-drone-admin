...
<%@ include file="/WEB-INF/jsp/egovframework/example/cmmn/common_lib.jsp" %>
	...
	<!-- 2019.01.18 payment Add Start -->
    <!-- chartist CSS -->
    <link href="<c:url value='/common/css/chartist-js/dist/chartist.min.css'/>" rel="stylesheet">
    <link href="<c:url value='/common/css/chartist-js/dist/chartist-init.css'/>" rel="stylesheet">
    <link href="<c:url value='/common/css/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css'/>" rel="stylesheet">
    <link href="<c:url value='/common/css/css-chart/css-chart.css'/>" rel="stylesheet">
    <!--This page css - Morris CSS -->
    <link href="<c:url value='/common/css/morrisjs/morris.css'/>" rel="stylesheet">

    <!-- page css -->

    <script src="<c:url value='/common/css/gauge/gauge.min.js'/>"></script>
    <script src="<c:url value='/common/js/pages/widget-data.js'/>"></script>
    <!-- 2019.01.18 payment Add End -->
...
$(function() {
  ...
  <!-- Row -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <img class="card-img-top img-responsive" src="<c:url value='/common/images/products/Mavic/Mavic 2/main/main_1.jpg'/>" alt="Card image cap">
                            <div class="card-body">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <img class="card-img-top img-responsive" src="<c:url value='/common/images/products/Mavic/Mavic Air/main/main_1.jpg'/>" alt="Card image cap">
                            <div class="card-body">
                                <ul class="list-inline font-14">
                                    <li class="p-l-0">20 May 2016</li>
                                    <li><a href="javascript:void(0)" class="link">3 Comment</a></li>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <img class="card-img-top img-responsive" src="<c:url value='/common/images/products/Phantom/Phantom4 Pro/main/main_1.png'/>" alt="Card image cap">
                            <div class="card-body">
                                <ul class="list-inline font-14">
                                    <li class="p-l-0">20 May 2016</li>
                                    <li><a href="javascript:void(0)" class="link">3 Comment</a></li>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="social-widget">
                                        <div class="soc-header box-facebook"><i class="fab fa-facebook"></i></div>
